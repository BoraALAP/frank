...
var hoistStatics__default = /*#__PURE__*/_interopDefault(hoistStatics);
...
const SchemaContext = /*#__PURE__*/React__default['default'].createContext({});

const typeToRegex = type => new RegExp(`^${type}:`);

const queriesToPath = queries => queries.map(query => [apolloCacheInvalidation.ROOT, new RegExp(`^${query}`)]); // Turns this
// [{ type: "Event", relatedFields: ["rsvps", "_rsvpsMeta"] }]
// Into this
// [[/^Event:/, /^rsvps/], [/^Event:/, /^_rsvpsMeta/]]


const relatedFieldsToPath = relatedFields => flatten(relatedFields.map(relatedField => (relatedField.fields || []).map(relatedPath => [typeToRegex(relatedField.type), new RegExp(`^${relatedPath}`)]))); // Gives us something like:
// {
//   RSVP: [[/^RSVP:/], [ROOT, /^_allRSVPsMeta/], [ROOT, /^allRSVPs/], [/^Event:/, /^_rsvpsMeta/]]
// }


const generateInvalidateionPaths = memoizeOne__default['default'](keystoneTypes => keystoneTypes.reduce((memo, {
  schema: {
    type,
    queries = [],
    relatedFields = []
  ...
  render() {
    const _this$props = this.props,
      ...
      children
          ...
          props = _objectWithoutProperties__default['default'](_this$props, ["children"]);
...
const KeystoneQuery = (_ref) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(components.Query, props, renderProps => /*#__PURE__*/React__default['default'].createElement(KeystoneApolloQueryCacheBuster, _extends__default['default']({}, renderProps, {
    children: children
  })));
};
  ...
  render() {
    const _this$props2 = this.props,
      ...
      update: updateProp = () => {}
          ...
          props = _objectWithoutProperties__default['default'](_this$props2, ["invalidateTypes", "children", "update"]);

    return /*#__PURE__*/React__default['default'].createElement(SchemaContext.Consumer, null, keystoneSchemaInfo => {
      const interceptedUpdateProp = wrapUpdateFunc(keystoneSchemaInfo, invalidateTypes, updateProp);
      return /*#__PURE__*/React__default['default'].createElement(components.Mutation, _extends__default['default']({}, props, {
        update: interceptedUpdateProp
      }), (mutation, info) => {
        const interceptedMutation = (_ref2) => {
          let {
            ...
            optimisticResponse
              ...
              rest = _objectWithoutProperties__default['default'](_ref2, ["update", "optimisticResponse"]);
          ...
          if (optimisticResponse) {
            ...
            interceptedUpdateOption = (...args) => {
              ...
              if (optimisticHandled) {
                return wrapUpdateFunc(keystoneSchemaInfo, invalidateTypes, updateOption)(...args);
              } else {
...
class KeystoneProvider extends React__default['default'].Component {
  render() {
    return /*#__PURE__*/React__default['default'].createElement(KeystoneQuery, {
      query: META_QUERY
    }, ({
      data,
      loading
      ...
      return /*#__PURE__*/React__default['default'].createElement(SchemaContext.Provider, {
...
const withKeystone = Component => {
  const WrappingComponent = props => /*#__PURE__*/React__default['default'].createElement(KeystoneProvider, null, /*#__PURE__*/React__default['default'].createElement(Component, props));

  WrappingComponent.displayName = `WithKeystone(${Component.displayName || Component.name})`;
  hoistStatics__default['default'](WrappingComponent, Component);
...
function injectIsOptimisticFlag(_ref3 = emptyObject) {
  let {
    ...
    defaults = emptyObject
      ...
      rest = _objectWithoutProperties__default['default'](_ref3, ["resolvers", "defaults"]);

  const injectIsOptimisticFlagToKeystoneTypes = memoizeOne__default['default']((inputResolvers, keystoneTypes) => (keystoneTypes || []).reduce((memo, {
    schema: {
      type
    }
  }) => _objectSpread(_objectSpread({}, memo), {}, {
...
const flattenApollo = options => reactAdopt.adopt(mapValues__default['default'](options, adoption => {
  ...
  return (_ref4) => {
    let {
      render
        ...
        props = _objectWithoutProperties__default['default'](_ref4, ["render"]);

    return /*#__PURE__*/React__default['default'].cloneElement(adoption, props, render);
  };
}));
