...
const frank = () => {
  return (
    <Container space padding gap title="Who is Frank?">
      <Content>
        <Text>
          <Subtitle>Cookie Policy for Frankwd</Subtitle>

          <p>
            This is the Cookie Policy for Frankwd, accessible from frankwd.com
          </p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                including; Facebook, Linkedin, Instagram and Google, will set
          ...
          <ul>
            <li>By visiting this link: https://frankwd.com/contactus</li>
          </ul>
        </Text>
        <ContactDetails />
      </Content>
